...
function autoInjectNavs(pageConf, parentPath, fileName) {
    ...
    if (indexH === -1) {
        console.error(chalk.bgRed('\n ERROR ') + chalk.white('The header placeholder is not in the router config file'));
        process.exit(1);
    }
    ...
    if (indexF === -1) {
        console.error(chalk.bgRed('\n ERROR ') + chalk.white('The footer placeholder is not in the router config file'));
        process.exit(1);
    }
    ...
    if (indexB === -1) {
        console.error(chalk.bgRed('\n ERROR ') + chalk.white('The placeholder is not in the breadcrumb config file'));
        process.exit(1);
    }
    ...
    if (indexM === -1) {
        console.error(chalk.bgRed('\n ERROR ') + chalk.white('The placeholder is not in the leftmenu config file'));
        process.exit(1);
    }
