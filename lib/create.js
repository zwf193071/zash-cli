...
function autoInjectNavs(pageConf, parentPath, fileName) {
    ...
    if (indexH === -1) {
        ...
        process.exit(0);
        throw new Error('The header placeholder is not in the router config file');
    }
    ...
    if (indexF === -1) {
        ...
        process.exit(0);
        throw new Error('The footer placeholder is not in the router config file');
    }
    ...
    if (indexB === -1) {
        ...
        process.exit(0);
        throw new Error('The placeholder is not in the breadcrumb config file');
    }
    ...
    if (indexM === -1) {
        ...
        process.exit(0);
        throw new Error('The placeholder is not in the leftmenu config file');
    }
